			...
			<h2 class="header-info online">Kevin<sup>®</sup> is still coding this sucker<sup>™</sup>.</h2>
			<div id='slider'>
			  <ul>
			    <li style='display:block'><div class="card" id="player"><p>Player.</p><em>100 Cards, v.0.1</em></div></li>
			    <li style='display:none'><div class="card black" id="czar"><p>Card Czar.</p><em>60 Cards</em></div></li>
